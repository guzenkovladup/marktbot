...
PAYMENT_TEXT = (
    ...
    "— Или адрес самовывоза: Berlin, ...\n"
    "После оплаты пришли чек сюда в чат."
)
...
PRODUCTS: List[Product] = [
    Product(id="p1", name="Товар 1", price=10, desc="Описание товара 1"),
    Product(id="p2", name="Товар 2", price=25, desc="Описание товара 2"),
    Product(id="p3", name="Товар 3", price=40, desc="Описание товара 3"),
]
...
async def checkout(call: CallbackQuery):
    ...
    await call.message.edit_text(
        "✅ Оформление заказа.\n"
        "Если всё верно — нажми «Подтвердить заказ».",
